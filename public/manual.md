...
2. [Arquitectura del Model de Dades i Jerarquia Excel](#2-arquitectura-del-model-de-dades-i-jerarquia-excel)
3. [Perfil 1: Guia per al/la Configurador/a de Plantilles i Model (Administració / Disseny)](#3-perfil-1-guia-per-alla-configuradora-de-plantilles-i-model-administració--disseny)
   ...
   - [3.4 Personalització del Disseny Visual dels Formularis (Grid, Etiquetes i Tooltips)](#34-personalització-del-disseny-visual-dels-formularis-grid-etiquetes-i-tooltips)
4. [Perfil 2: Guia per al/la Redactor/a i Gestor/a d'Expedients (Usuari/a Final)](#4-perfil-2-guia-per-alla-redactora-i-gestora-dexpedients-usuaria-final)
   - [4.1 Carrega i Importació de Dades d'Expedient](#41-carrega-i-importació-de-dades-dexpedient)
...
```
 ┌───────────────────────────┐      ┌───────────────────────────┐
 │   Model de Dades (Excel)  │  ▲   │   Plantilla Text (Jinja2) │
...
## 2. Arquitectura del Model de Dades i Jerarquia Excel
...
### 📊 Tipus de Fulls i Prefixing `OUT_`
...
| :--- | :--- | :--- | :--- |
| `OUT_pres` | 1 (Arrel) | **Key-Value (KV)** | Formulat d'un sol registre amb dades generals del contracte (títol, expedient, òrgan, etc.). |
...
### 3.4 Personalització del Disseny Visual dels Formularis (Grid, Etiquetes i Tooltips)
...
#### C. Etiquetes i Tooltips d'Ajuda (`title`)
...
### 4.1 Carrega i Importació de Dades d'Expedient
...
- **Camps Generals (Key-Value)**: Ompliu les dades del contracte a través de formularis ràpids amb etiquetes superiors.
...
### ❓ Per què un sumatori d'una sub-taula me queda a zero?
